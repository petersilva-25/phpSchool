...
<body>
	...
	<img src="images/php.png" width="375" height="360" alt=""/>
    <br>
    ...
    <ul>
        ...
        <li><a href="../php/c5_PHPSuperglobals.php">Superglobals</a></li>
        <li><a href="../php/challenge01.php">Challenge01</a></li>
    </ul>
    <br>
    <h1>Part III – PHP Forms</h1>
    <ul>
        <li><a href="../php/c11_PHP Form Handling.php">PHP Form Handling</a></li>
        <li><a href="../php/c12_PHPFormValidation.php">PHP Form Validation</a></li>
